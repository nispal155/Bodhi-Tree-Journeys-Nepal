...
export default function NotFound() {
  return (
    <div className="flex flex-col items-center justify-center min-h-[80vh] px-4 text-center">
      ...
      >
        <h1 className="text-9xl font-black text-transparent bg-clip-text bg-gradient-to-r from-orange-400 to-red-600 mb-4">
          404
        </h1>
      </motion.div>
      ...
      >
        ...
        <p className="text-lg text-slate-600 dark:text-slate-400 max-w-md mx-auto mb-8">
          The page you are looking for doesn't exist or has been moved to another peak. Let's get you back to base camp.
        </p>
        <Link 
          href="/" 
