    ...
    <main className="flex min-h-screen flex-col items-center justify-between font-sans">
      ...
      <div className="w-full bg-zinc-50 py-16 flex-grow">
        <div className="container mx-auto px-6 max-w-3xl">
          <h1 className="text-4xl md:text-5xl font-bold text-gray-900 mb-8 text-center">Terms of Booking</h1>
          <div className="bg-white p-8 rounded-2xl shadow-sm border border-gray-100 prose max-w-none text-gray-600">
            ...
            <h3 className="font-bold text-gray-900 text-xl mt-6 mb-3">Booking and Payment</h3>
            ...
            <h3 className="font-bold text-gray-900 text-xl mt-6 mb-3">Cancellations</h3>
            ...
            <h3 className="font-bold text-gray-900 text-xl mt-6 mb-3">Travel Insurance</h3>
