...
export default function TourCategories({ limit, showViewAll = false, hideHeader = false }: TourCategoriesProps) {
  ...
  return (
    <section id="packages" className="w-full py-24 bg-white">
      <div className="container mx-auto px-6 text-center">
        {!hideHeader && (
          <>
            ...
            <p className="text-gray-600 mb-16 max-w-2xl mx-auto">Carefully crafted itineraries for deep cultural immersion and breathtaking adventure.</p>
          </>
        )}
        ...
        {showViewAll && (
          <Link href="/packages" className="inline-flex items-center gap-2 px-8 py-3 rounded-full border-2 border-orange-200 text-orange-500 font-bold hover:bg-orange-50 transition-colors">
            View All Packages
