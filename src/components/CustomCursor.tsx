...
export default function CustomCursor() {
  ...
  return (
    <>
      ...
      <motion.div
        className="fixed top-0 left-0 w-2 h-2 bg-orange-500 rounded-full pointer-events-none z-[9999] mix-blend-difference hidden md:block"
        style={{
          // We don't use spring here so it feels instantly responsive
