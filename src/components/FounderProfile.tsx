...
export default function FounderProfile() {
  return (
    <section className="w-full py-24 bg-white dark:bg-slate-900 border-t border-zinc-100 dark:border-slate-800 transition-colors duration-300">
      <div className="container mx-auto px-6 max-w-5xl">
        <div className="flex flex-col md:flex-row gap-12 items-center">
          <div className="w-full md:w-1/3 relative flex justify-center">
            <div className="relative w-64 h-64 md:w-full md:h-[400px] rounded-3xl overflow-hidden shadow-2xl border-4 border-white dark:border-slate-700">
              <Image 
                src="/avatar-2.jpg" 
          ...
          <div className="w-full md:w-2/3">
            ...
            <div className="bg-white dark:bg-slate-800 p-6 rounded-2xl shadow-sm border border-gray-100 dark:border-slate-700 flex flex-col sm:flex-row gap-6 sm:items-center justify-between">
              <div>
            ...
            <div className="mt-6 flex items-center gap-3 text-gray-600 dark:text-gray-300 bg-gray-50 dark:bg-slate-800 inline-flex px-4 py-2 rounded-lg border border-gray-100 dark:border-slate-700">
